...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Continent asia = new Continent("Asia","WIP","images/asia.jpg");
        Continent africa = new Continent("Africa","WIP","images/africa.jpg");
        Continent australia = new Continent("Australia","WIP","images/australia.jpg");
        Continent europe = new Continent("Europe","WIP","images/europe.jpg");
        Continent northAmerica = new Continent("North America","WIP","images/northAmerica.jpg");
        Continent southAmerica = new Continent("SouthAmerica","WIP","images/southAmerica.jpg");
        ...
        Trek trek3 = new Trek( "Haute Route", "Difficult", description3, "2400", "images/hauteRoute1.jpg", europe);
