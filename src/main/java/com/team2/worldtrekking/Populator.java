...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Continent asia = new Continent("Asia", "region", "https://placekitten.com/640/360\n");
        Continent europe = new Continent("Europe", "region", "https://placekitten.com/640/360\n");
        Continent africa = new Continent("Africa", "region", "https://placekitten.com/640/360\n");
        Continent southAmerica = new Continent("South America", "region", "https://placekitten.com/640/360\n");
        Continent northAmerica = new Continent"North America", "region", "https://placekitten.com/640/360\n");
        Continent australasia = new Continent("Australasia", "region", "https://placekitten.com/640/360\n");
...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Trek trek3 = new Trek(3L, "Haute Route", "Difficult", description3, "2400", "images/kungsleden2.jpeg",Europe);
...
>>>>>>> 8f5db4dc8d851cb94a97089cf04a721bed04ca08
